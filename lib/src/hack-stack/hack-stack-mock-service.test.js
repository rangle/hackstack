...
describe('Hack Stack Mock tests', function () {
  ...
  describe('GET tests', function () {
    ...
    it(
      'should return the right object if options.makeCompareFn is defined',
      function () {
        var tag = mockObject1.tags[0];
        var hack = hs([mockObject1, mockObject2], {
          makeCompareFn: function (requestData) {
            return R.compose(R.contains(requestData), function (
              obj) {
              return obj.tags;
            });
          }
        ...
        hack.disableRandomErrors(true);
        hack.get(tag).then(function (result) {
          expect(result).to.have.property('data').and.deep.equal(
            mockObject1);
        }, function (i) {
          console.log(i);
